...
\begin{abstract}
In this thesis, we consider models for survival data with high-dimensional explanatory covariates.
...
Finally, FHTBoost is applied to a data set of neuroblastoma, where it achieves a predictive power, measured by Brier score, that is comparable to a Cox model.
\end{abstract}