...
\subsection{Examples of first-hitting-time models}\label{subsec:fht-examples}
...
\subsection{The inverse Gaussian parameterization with $y_0$, $\mu$ and $\sigma$ is overdetermined}
