...
Consider the task of deriving a general prediction $\eta$ by minimizing the expectation of a loss function $\rho(\cdot,\,\cdot)$
...
additive predictor. For a schematic overview, see Algorithm \ref{algo:fgd}.
\begin{algorithm}
