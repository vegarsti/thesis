...
\end{equation*}
hence the resulting additive predictor is a sum of component-wise predictors in the GAM form of \eqref{gam}. For a schematic overview of the algorithm, see Algorithm \ref{algo:component-wise}.
\begin{algorithm}
