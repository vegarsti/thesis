\chapter{Application on a neuroblastoma data set}
...
\centering\includegraphics[scale=0.4]{age_hist_finer.pdf}
\end{figure}
...
\subsubsection{Results: Baseline, null model, interpretation}
...
\centering\includegraphics[scale=0.4]{example_wieners.pdf}
\end{figure}
...
\end{equation}
Whereas for those not designated as high-risk, it is
\begin{equation}
